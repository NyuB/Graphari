...
public class TextLongLongDirectedDouble extends TextVertexInputFormat<LongWritable, LongWritable, DoubleWritable> {
	...
	class CustomReader extends TextVertexReaderFromEachLineProcessed<FourStringFields> {
		...
		@Override
		protected LongWritable getValue(FourStringFields line) throws IOException {

			return new LongWritable(Long.parseLong(line.value));
		}
